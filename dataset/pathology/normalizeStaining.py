...
def estimateHE(img, Io=255, alpha=1, beta=0.15):
...
def normalizeStaining(img, saveFile=None, Io=255, alpha=1, beta=0.15, HERef=None, maxCRef=None):
    ''' Normalize staining appearence of H&E stained images
...
if __name__=='__main__':
    ...
    parser.add_argument('--Io', type=int, default=255)
